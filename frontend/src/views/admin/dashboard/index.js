...
const Dashboard = () => {
  ...
  return (
    <>
      ...
      {/* <!-- Page Header--> */}
      <div className="mt-2 mx-4 p-6 rounded-sm bg-indigo-500 mb-6">
        {/* <!-- Content --> */}
        <div className="">
          ...
          <div className="mt-5">
            ...
            <div className="bg-slate-900 p-7 mt-4">
              ...
              <div className="flex items-center justify-center mt-6 gap-4">
                <button className="px-5 py-1 bg-transparent border border-indigo-500 hover:bg-indigo-600 text-indigo-500">
                  Import {selectedImportOption}
                </button>
                <button className="px-5 py-1 bg-indigo-500 hover:bg-indigo-600 text-white">
                  Import {selectedImportOption}
                </button>
              </div>
            </div>
