  ...
  return (
    <>
      <div className="mb-6 flex items-center justify-between">
        <h1 className="text-slate-800 font-bold text-3xl">Poll list</h1>
        <div className="grid auto-cols-max justify-end grid-flow-col gap-3">
          <button className="text-red-500 bg-gray-100 border border-gray-600 px-9 rounded items-center hover:bg-gray-200">
            Delete
          </button>
      ...
      <div className="w-full overflow-hidden rounded-sm shadow-xs mb-8">
        <div className="w-full overflow-x-auto">
          <table className="w-full">
            ...
            <tbody className="bg-white divide-y">{polls && renderList()}</tbody>
          </table>
        </div>
        {pagination && (
          <PaginationComponent
